...
FT_ICVL_ALL_CFG = {
    "fixedga30_a0": {
        ...
        "noise_path": "../icvl/fixedga30.mat",
        "clean_path": "../icvl/orig.mat",
        "log_dir": "saved_models/icvl/<DIR>/fixedga30_a0",
    ...
    "fixedga70_a0": {
        ...
        "batch_size": 8,
        "learning_rate": 0.0006,
        "noise_path": "../icvl/fixedga70.mat",
        "clean_path": "../icvl/orig.mat",
        "log_dir": "saved_models/icvl/<DIR>/fixedga70_a0",
        "pretrained_path_2d": "saved_models/cave/beta_2d_pt/randga95_im_a8/exp_6/models/epoch_100",
        "alpha": 0.0,
    },
    "fixedga70_im_a8": {
        ...
        "batch_size": 8,
        "learning_rate": 0.0006,
        "noise_path": "../icvl/fixedga70_im.mat",
        "clean_path": "../icvl/orig.mat",
        "log_dir": "saved_models/icvl/<DIR>/fixedga70_im_a8",
        "pretrained_path_2d": "saved_models/cave/beta_2d_pt/randga95_im_a8/exp_6/models/epoch_100",
        "alpha": 0.8,
    },
    "randga55_a0": {
        ...
        "batch_size": 8,
        "learning_rate": 0.0006,
        "noise_path": "../icvl/randga55.mat",
        "clean_path": "../icvl/orig.mat",
        "log_dir": "saved_models/icvl/<DIR>/randga55_a0",
        "pretrained_path_2d": "saved_models/cave/beta_2d_pt/randga95_im_a8/exp_6/models/epoch_100",
        "alpha": 0.0,
    },
    "randga95_a0": {
        ...
        "batch_size": 8,
        "learning_rate": 0.0006,
        "noise_path": "../icvl/randga95.mat",
        "clean_path": "../icvl/orig.mat",
        "log_dir": "saved_models/icvl/<DIR>/randga95_a0",
        "pretrained_path_2d": "saved_models/cave/beta_2d_pt/randga95_im_a8/exp_6/models/epoch_100",
        "alpha": 0.0,
    },
    "randga95_im_a8": {
        ...
        "clean_path": "../icvl/orig.mat",
        "log_dir": "saved_models/icvl/<DIR>/randga95_im_a8",
        "pretrained_path_2d": "saved_models/cave/beta_2d_pt/randga95_im_a8/exp_6/models/epoch_100",
        "alpha": 0.8,
    }
}
...
def finetune(model, train_loader, test_loader, optimizer, criterion,
    ...
    scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[15, 180, ], gamma=0.25, last_epoch=-1)
...
class ICVLFTer:
    def __init__(self, cfg_name, is_freeze=False):
        ...
        if is_freeze:
            ft_cfg = FT_ICVL_FREEZE_CFG[cfg_name]
        else:
            ft_cfg = FT_ICVL_ALL_CFG[cfg_name]
        self.ft_cfg = ft_cfg
