...
class IndianTrain:
    def __init__(self, cfg_name):
        self.ft_cfg = FT_IP_ALL_CFG[cfg_name]
        ft_cfg = FT_IP_ALL_CFG[cfg_name]
    ...
    def _load_data(self):
        ...
        self.hsi_shape = noise_imgs.shape  # store img shape (220 512 512)
