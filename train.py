...
from model_gru import RCSCNet
# from model_gru_concat import RCSCNet
...
FT_CAVE_ALL_CFG = {
    ...
    "randga95_a0": {
        ...
        "log_dir": "saved_models/cave/<DIR>/randga95_linear",
        # "pretrained_path_2d": "saved_models/cave/beta_2d_pt/randga95_a0/exp_4/models/epoch_100",
        "pretrained_path_2d": "saved_models/cave/gamma_ftall/randga95_linear/exp_0/models/epoch_100",
        "scene_id": 0,
        "alpha": 0.0,
    },
    "randga95_im_a8": {
...
FT_DFC_ALL_CFG = {
    "randga95_a0": {
        ...
        "log_dir": "saved_models/dfc2018/y0_x1024/<DIR>/randga75_a0",
        "pretrained_path_2d": "saved_models/cave/beta_2d_pt/randga55_a0/exp_1/models/epoch_100",
        "alpha": 0.0,
        "crop_size": (28, 64, 64),
    },
    ...
    "randga95_im_a8": {
        ...
        "clean_path": "../dfc/orig.mat",
        "log_dir": "saved_models/dfc2018/y0_x1024/<DIR>/randga75_im_a8",
        "pretrained_path_2d": "saved_models/cave/beta_2d_pt/randga95_im_a8/exp_6/models/epoch_100",
        "alpha": 0.0,
        "crop_size": (28, 64, 64),
    }
...
def finetune(model, train_loader, test_loader, optimizer, criterion,
    ...
    scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[100, 150, 180], gamma=0.3, last_epoch=-1)
...
class CaveFTer:
    def __init__(self, cfg_name, is_freeze=False):
        if is_freeze:
            ft_cfg = FT_CAVE_FREEZE_CFG[cfg_name]
        else:
    ...
    def finetune(self, model, train_loader, test_loader):
        ...
        scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[20, 60], gamma=0.25, last_epoch=-1)
        model_save_dir = os.path.join(log_dir, 'models')
        if not os.path.exists(model_save_dir):
            os.mkdir(model_save_dir)
...
class DFCFTer:
    def __init__(self, cfg_name, is_freeze=False):
        ...
        if is_freeze:
            ft_cfg = FT_DFC_FREEZE_CFG[cfg_name]
        else:
        ...
        # build model
        model = build_model(self.model_cfg, self.ft_cfg, is_freeze)
